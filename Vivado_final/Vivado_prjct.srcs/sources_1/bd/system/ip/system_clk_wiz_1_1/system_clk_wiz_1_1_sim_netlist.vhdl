...
architecture STRUCTURE of system_clk_wiz_1_1_system_clk_wiz_1_1_clk_wiz is
  signal MB_clk_system_clk_wiz_1_1 : STD_LOGIC;
  signal MB_clk_system_clk_wiz_1_1_en_clk : STD_LOGIC;
  ...
  signal periph_clk_system_clk_wiz_1_1 : STD_LOGIC;
  signal periph_clk_system_clk_wiz_1_1_en_clk : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => periph_clk_system_clk_wiz_1_1,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => periph_clk,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => periph_clk_system_clk_wiz_1_1_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => MB_clk_system_clk_wiz_1_1_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg2(0),
      R => '0'
